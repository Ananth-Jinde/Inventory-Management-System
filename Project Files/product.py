...
class productClass:
    def __init__(self,root):
        ...
        product_Frame.place(x=10,y=10,width=450,height=460)
    ...
    #===Product Details===
        ...
        p_frame.place(x=480,y=100,width=570,height=370)
        ...
        self.product_table.column("Category",width=65)
        self.product_table.column("Supplier",width=65)
        self.product_table.column("name",width=65)
        self.product_table.column("price",width=65)
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get()=="Select":
                ...
                col=col_map.get(self.var_searchby.get())
                if not col:

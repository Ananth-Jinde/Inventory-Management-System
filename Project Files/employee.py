...
class employeeClass:
    def __init__(self,root):
        ...
        #==title====
        title=Label(self.root,text="Employee Details",font=("goudy old style",15),bg="#0f4d7d",fg="white").place(x=30,y=100,width=1000)
        ...
        self.EmployeeTable.config(xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)

...
class supplierClass:
    def __init__(self,root):
        ...
        txt_search=Entry(self.root,textvariable=self.var_searchtxt,font=("goudy old style",15),bg="lightyellow").place(x=800,y=80,width=120)
        btn_search=Button(self.root,text="Search",command=self.search,font=("goudy old style",20,"bold"),bg="#4caf50",fg="white",cursor="hand2").place(x=930,y=79,width=100,height=28)


        #==title====
        title=Label(self.root,text="Supplier Details",font=("goudy old style",15),bg="#0f4d7d",fg="white").place(x=30,y=10,width=1000,height=40)
        ...
        emp_frame.place(x=700,y=120,width=340,height=350)
        ...
        self.supplierTable.config(xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)

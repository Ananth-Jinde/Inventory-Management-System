...
class salesClass:
    def __init__(self,root):
        ...
        #========image=========
        self.bill_photo=Image.open("assets/images/cat2.jpg")
...
#==============================================
    def show(self):
        ...
        for i in os.listdir('data/bills'):
    ...
    def get_data(self,ev):
        ...
        with open(f'data/bills/{file_name}','r') as fp:
            for i in fp:
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.bill_list:
                self.bill_area.delete('1.0',END)
                with open(f'data/bills/{self.var_invoice.get()}.txt','r') as fp:
                    for i in fp:
                        self.bill_area.insert(END,i)

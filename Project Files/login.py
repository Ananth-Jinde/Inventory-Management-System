...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("Login System | Developed by Jinde Anantha Sai")
        self.root.geometry("1350x700+0+0")
        self.root.config(bg="#fafafa")
        self.root.wm_iconbitmap("assets/icons/IMS_ICON.ico")
        self.otp=''
        #====images====================
        self.phone_image=ImageTk.PhotoImage(file="assets/images/phone.png")
        self.lbl_phone_image=Label(self.root,image=self.phone_image,bd=0).place(x=200,y=12)
        #===Login Frame===============
        ...
        #====Animation Tools============
        self.im1=ImageTk.PhotoImage(file="assets/images/im1.png")
        self.im2=ImageTk.PhotoImage(file="assets/images/im2.png")
        self.im3=ImageTk.PhotoImage(file="assets/images/im3.png")
        self.lbl_change_image=Label(self.root,bg="white")
        self.lbl_change_image.place(x=367,y=115,width=240,height=428)
        self.animate()
    #========all functions==================
    def animate(self):
        self.im=self.im1
    ...
    def forget_window(self):
        ...
        try:
            if self.employee_id.get()=="":
                ...
                email=cur.fetchone()
                if email==None:
                    messagebox.showerror("Error","Invalid Employee ID, please try again",parent=self.root)
                else:
                    #forget window
                    ...
                    if chk=='f':
                        ...
                        txt_reset=Entry(self.forget_win,textvariable=self.var_otp,font=("times new roman",15),bg="lightyellow").place(x=25,y=90,width=250,height=30)
                        self.btn_reset=Button(self.forget_win,text="SUBMIT",command=self.validate_otp,font=("times new roman",15),bg="lightblue")
                        self.btn_reset.place(x=285,y=90,width=100,height=30)
                        new_pass=Label(self.forget_win,text="New Password",font=("times new roman",15)).place(x=20,y=160)
                        txt_new_pass=Entry(self.forget_win,textvariable=self.var_new_pass,font=("times new roman",15),bg="lightyellow").place(x=25,y=190,width=250,height=30)
                        lbl_c_pass=Label(self.forget_win,text="Confirm Password",font=("times new roman",15)).place(x=20,y=225)
                        txt_c_pass=Entry(self.forget_win,textvariable=self.var_conf_pass,font=("times new roman",15),bg="lightyellow").place(x=25,y=255,width=250,height=30)
    ...
    def validate_otp(self):
        try:
            ...
            messagebox.showerror("Error","OTP should be numeric",parent=self.forget_win)
    def send_email(self,to_):
        try:
            email_=email_pass.email_
            pass_=email_pass.pass_
            if not email_ or not pass_:
                return 'f'

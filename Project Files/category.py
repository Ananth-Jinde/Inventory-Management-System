...
#==============category details==========================
        ...
        self.categoryTable.config(xscrollcommand=scrollx.set,yscrollcommand=scrolly.set)
        ...
        #=======images=====
        self.im1=Image.open("assets/images/cat.jpg")
        ...
        self.im2=Image.open("assets/images/category.jpg")
